# Reaper Studios Starter Package (Golang/React)

This will serve as a basis for future projects that Reaper Studios will participate in, should they require a stack of this caliber. Typically, this will be used for projects which require a significant amount of processing to complete.

# Parent project stuff
